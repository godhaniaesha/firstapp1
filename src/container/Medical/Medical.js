    ...
    return (
        <div>
            <Row>
                {
                    data.map((v, i) => (
                        <Col lg={3}  md={6} className="text-center card-col p-3" key={v.id} >
                            <Card
                                className="my-2"
                                color="info"
                                outline
                            ...
                            >
                                ...
                                <CardBody>
                                    <CardTitle >
                                        <span className='d-flex justify-content-center gap-3'><p><b>Price</b> : {v.price}</p>
                                            <p className='text-danger'  ><b>Expiry</b> : {v.expiry}</p> </span>
